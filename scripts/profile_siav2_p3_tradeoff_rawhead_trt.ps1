...
conda run --no-capture-output -n yolov7 python tools\summarize_trt_log.py `
    --log $logs `
    --json-out "$trtDir\p3_tradeoff_rawhead_trt_summary.json" `
    --csv-out "$trtDir\p3_tradeoff_rawhead_trt_summary.csv"

conda run --no-capture-output -n yolov7 python tools\analyze_trt_reformat.py `
    --log $logs `
    --json-out "$trtDir\p3_tradeoff_rawhead_reformat_summary.json" `
    --csv-out "$trtDir\p3_tradeoff_rawhead_reformat_summary.csv"
